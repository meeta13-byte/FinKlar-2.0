...
private val DynamicDarkColorScheme = darkColorScheme(
    primary             = Color(0xFF19C37D),      // Primary green
    onPrimary           = Color(0xFF080A09),      // Background
    primaryContainer    = Color(0xFF0D6B47),      // Dark green
    onPrimaryContainer  = Color(0xFFF4F7F5),      // Primary text
    secondary           = Color(0xFF32E68C),      // Bright green
    onSecondary         = Color(0xFF080A09),
    secondaryContainer  = Color(0xFF1B241F),      // Elevated surface
    onSecondaryContainer = Color(0xFFF4F7F5),
    tertiary            = Color(0xFF8CF5C5),      // Soft mint
    onTertiary          = Color(0xFF080A09),
    tertiaryContainer   = Color(0xFF151B18),      // Card surface
    onTertiaryContainer = Color(0xFFF4F7F5),
    background          = Color(0xFF080A09),      // Background
    onBackground        = Color(0xFFF4F7F5),      // Primary text
    surface             = Color(0xFF151B18),      // Card surface
    onSurface           = Color(0xFFF4F7F5),      // Primary text
    surfaceVariant      = Color(0xFF101412),      // Secondary background
    onSurfaceVariant    = Color(0xFF9AA59F),      // Secondary text
    outline             = Color(0xFF26312C),      // Border
    outlineVariant      = Color(0xFF26312C),      // Border
    error               = Color(0xFFFF5C67),      // Debit / negative
    onError             = Color.White,
